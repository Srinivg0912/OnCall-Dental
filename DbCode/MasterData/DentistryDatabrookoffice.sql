...
VALUES ('Brookside Dental Care',NULL
		,NULL
		,'brookside','brooksidelogo.png',NULL,NULL
...
VALUES ((SELECT DentistryId FROM tbl_dentistry WHERE DentistryName='Brookside Dental Care')
		,'Kentucky','-82.735662','37.654606','306 Wrights Lane,','Prestonsburg, KY,'
		,(SELECT StateId From tbl_states WHERE StateCode='KY')
		,(SELECT CountryId From tbl_country WHERE CountryCode='US')
		,'41653',(SELECT LookupValueId FROM tbl_lookup_value WHERE LookupCode='LOCATION_TYPE_HEAD_OFFICE')
		,NULL,@StatusActiveId,CURRENT_DATE, -1, CURRENT_DATE, -1);
...
INSERT INTO tbl_dentistry_location_contacts (DentistryId,ContactName,PhoneNumber,Mobile,EmailId,ContactTypeId
											,Description,StatusId,CreatedDate,CreatedBy,LastUpdateDate,LastUpdatedBy)
VALUES ((SELECT DentistryId FROM tbl_dentistry WHERE DentistryName='Brookside Dental Care')
		,'Dr.Bryan Griffth','606-874-9311',NULL,NULL
...
VALUES ((SELECT DentistryId FROM tbl_dentistry WHERE DentistryName='Brookside Dental Care')
		...
		,NULL,'bryan.png','Dr. Griffith attended dental school at the University of Kentucky and he has been practicing since 1993. He and his family reside in Prestonsburg. He has trained with some of the world’s most prominent sedation dental specialists and is rapidly becoming known as Prestonsburg’s leading dentist for people who want sedation dentistry.
I am proud to have served patients in our community since 1993. The combination of continuing education and state-of-the-art equipment allow us to offer you and your family the high level of care you’re looking for. My team and I will give you a warm welcome and our ongoing commitment to your dental health.',NULL,NULL
		,NULL,@StatusActiveId,CURRENT_DATE, -1, CURRENT_DATE, -1);
...
INSERT INTO tbl_dentistry_user (DentistryId,DentistryStaffId,UserName,Password,AccessRoleId
							,Description,StatusId,CreatedDate,CreatedBy,LastUpdateDate,LastUpdatedBy)
VALUES ((SELECT DentistryId FROM tbl_dentistry WHERE DentistryName='Brookside Dental Care')
		,(SELECT DentistryStaffId FROM tbl_dentistry_staff WHERE DentistryId=(SELECT DentistryId FROM tbl_dentistry WHERE DentistryName='Brookside Dental Care'))
		,'brooksidedental','oncall@123'
